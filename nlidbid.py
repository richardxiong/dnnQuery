...
tf.app.flags.DEFINE_string("data_dir", "./one_learn/ba_%s" % subset, "Data directory")
tf.app.flags.DEFINE_string("train_dir", "./ba_%s" % subset, "Training directory.")
...
tf.app.flags.DEFINE_string("test_dir", "./evaluation/one_learn/ba_%s" % subset, "Test directory")
