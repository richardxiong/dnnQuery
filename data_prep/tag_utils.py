    ...
    field2word = {
      ...
      'U.S._Open': {'value_type':'int',
			...
			'Team':{'value_type': 'string', 
                     'value_range': ['Greystones','Ballymore_Eustace','Maynooth','Ballyroan_Abbey','Fingal_Ravens','Confey',
                        'Crettyard','Wolfe_Tones','Dundalk_Gaels',
      ...
      'Left_office':{'value_type': 'date', 
			...
			'Name': {'value_type':'string',
						'value_range': ['Ned_Barkas','Harry_Brough','George_Brown','Jack_Byers','Ernie_Islip','Billy_Johnston','Robert_Jones','Frank_Mann','Len_Marlow','Colin_McKay',
            'Sandy_Mutch','Stan_Pearson','George_Richardson','Charlie_Slade','Billy_E._Smith','Billy_H._Smith','Clem_Stephenson','Jack_Swann',
      ...
      'Goals': {'value_type':'int',
			...
			'1st_Venue': {'value_type': 'string', 
                       'value_range': ['Sheffield','Tijuana','Doha','Qingdao','Moscow','Dubai','Beijing'], 
            ...
            '3rd_Venue': {'value_type': 'string', 
                       'value_range': ['Nanjing','Sheffield','Moscow','Veracruz','Edinburgh','London'], 
                       'query_word': ['city', '3rd_venue']}, 
            '4th_Venue': {'value_type': 'string', 
                       'value_range': ['NA','Tijuana','Guanajuato','Moscow',], 
