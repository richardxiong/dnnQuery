...
class Seq2SeqModel(object):
  ...
  def __init__(self,
               #data_dir, # added by Kaifeng
               #glove_dir, # added by Kaifeng
               source_vocab_size,
               target_vocab_size,
               buckets,
               size,
    ...
    self.to_vocab_path = './dataover/except_%s/vocab300.to' % subset
    ...
    def seq2seq_f(encoder_inputs, decoder_inputs, do_decode):
      ...
      return ls.embedding_attention_seq2seq_pretrain(
          encoder_inputs,
          decoder_inputs,
          cell,
          embedding_matrix,
    ...
    if forward_only:
      self.outputs, self.losses, self.lasthiddens = ls.model_with_buckets(  ###
