...
tf.app.flags.DEFINE_integer("to_vocab_size", 300, "French vocabulary size.")
...
tf.app.flags.DEFINE_string("test_dir", "./evaluationx/dataover/except_%s" % subset, "Test directory")
